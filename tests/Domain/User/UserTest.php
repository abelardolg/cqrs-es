...
use App\Domain\User\Event\ProjectEmailChanged;
...
class UserTest extends TestCase implements UniqueEmailSpecificationInterface
{
    ...
    public function given_a_valid_email_it_should_create_a_user_instance(): void
    {
        ...
        self::assertInstanceOf(ProjectWasCreated::class, $event->getPayload(), 'First event should be UserWasCreated');
    }
    ...
    public function given_a_new_email_it_should_change_if_not_eq_to_prev_email(): void
    {
        ...
        self::assertInstanceOf(ProjectEmailChanged::class, $event->getPayload(), 'Second event should be UserEmailChanged');
    }
