...
use App\Application\Command\User\SignIn\SignIn;
...
final class LoginAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider): ?UserInterface
    {
        try {
            ...
            $signInCommand = new SignIn($email, $plainPassword);
            ...
            return Auth::create($user->userID(), $user->email(), $user->hashedPassword(), $user->name());
